...
public class M6 extends Base3{
	@Test
	 public void test2() throws InterruptedException{
		...
		getElementWhileSetWebDriverWait(driver,By.cssSelector("input[class='upload-pic']")).sendKeys("C:\\Users\\viphj\\Desktop\\uipicture\\6a.jpg");
