...
public class M2 extends Base2{
	@Test
	 public void test2() throws InterruptedException{
		...
		getElementWhileSetWebDriverWait(driver,By.cssSelector("input[class='upload-pic']")).sendKeys("C:\\Users\\viphj\\Desktop\\uipicture\\2a.jpg");
